                ...
                Column(mainAxisAlignment: MainAxisAlignment.start,
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      margin: const EdgeInsets.fromLTRB(50,20,20,20),
                      padding: const EdgeInsets.fromLTRB(0, 40, 0, 40),
                      child: const Text('Grey.shade600',style: TextStyle(color: Colors.red),),
                    ),
                    Container(
                      height: 100,
                      width: 200,
                      ...
                      margin: const EdgeInsets.fromLTRB(50,20,20,20),
                      padding: const EdgeInsets.fromLTRB(0, 40, 0, 40),
                      child: const Text('Grey.shade800',style: TextStyle(color: Colors.blue),),
                    ),
                        ],
                    ),
                    Container(
                      ...
                      margin: const EdgeInsets.fromLTRB(20, 20, 20, 20),
                      padding: const EdgeInsets.fromLTRB(0, 40, 0, 40),
                      child: const Text('pink.shade400'),
                    )
                  ],
                ),
                ElevatedButton(onPressed: () => Navigator.of(context).pop(), child: const Text('トップへ戻る')),
